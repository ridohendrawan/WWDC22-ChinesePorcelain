...
//                patternShapeSketch-1
                Button(action: {
                    withAnimation {
                        viewRouter.currentPage = .Page06c1
                    }
                }) {
...
//                patternShapeSketch-2
                Button(action: {
                    withAnimation {
                        viewRouter.currentPage = .Page06c2
                    }
                }) {
...
//                patternShapeSketch-3
                Button(action: {
                    withAnimation {
                        viewRouter.currentPage = .Page06c3
                    }
                }) {
...
struct page05cView_Previews: PreviewProvider {
